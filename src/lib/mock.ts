...
export const mockBootstrap: Bootstrap = {
    ...
    envs: [
      {
        ...
        values: ["1"],
        requires: null,
        help: "Use the in-kernel ntsync driver for faster synchronization.",
        details: "Replaces esync/fsync with /dev/ntsync.",
  ...
  recipes: [
    ...
    },
    {
      ...
      kind: "profile",
      description: "GameMode + low-latency layer + NTSync with an FPS readout.",
      symptom: null,
      gpu: null,
      needs: ["ntsync"],
      icon: "gauge",
      accent: "#7aa2f7",
      tags: ["NTSync", "GameMode"],
  ...
  runtimes: [
    ...
    {
      internal_name: "GE-Proton10-34",
      display_name: "GE-Proton10-34",
      kind: "user",
      path: "/home/you/.local/share/Steam/compatibilitytools.d/GE-Proton10-34",
    },
  ],
  games: [
